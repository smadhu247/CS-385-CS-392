...
int main(int argc, char **argv) {
    ...
    // *(arr + 0*(sizeof(char*))) = (char *)malloc((MAX_STRLEN + 1) * sizeof(char));
    // *(arr + 1*(sizeof(char*))) = (char *)malloc((MAX_STRLEN + 1) * sizeof(char));
    // *(arr + 2*(sizeof(char*))) = (char *)malloc((MAX_STRLEN + 1) * sizeof(char));
    // *(arr + 3*(sizeof(char*))) = (char *)malloc((MAX_STRLEN + 1) * sizeof(char));
    // *(arr + 4*(sizeof(char*))) = (char *)malloc((MAX_STRLEN + 1) * sizeof(char));
    ...
    // quicksort(arr, 5, sizeof(char *), str_cmp);
    // for(int i = 0; i < 5; i++){
    //     printf("%s, ", *(arr + i));
    // }
